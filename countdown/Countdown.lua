function Update()
    local targets = {
        {day = 30, month = 1, year = 2023, endtxt="until cs exam"},
        {day = 31, month = 1, year = 2023, endtxt="until avdfunctions exam"},
        {day = 1, month = 2, year = 2023, endtxt="until english exam"},
        {day = 30, month = 4, year = 2023, endtxt="finalize highschool volunteer hours"},
        {day = 27, month = 7, year = 2023, endtxt="until end of school"},
        {day = 27, month = 7, year = 2999, endtxt="thing overflows"},
    ...
    for i, target in ipairs(targets) do
        local targetTime = os.time({day = target.day, month = target.month, year = target.year, hour = 0, min = 0, sec = 0})
